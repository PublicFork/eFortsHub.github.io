...
const gunnahmatcher = new RegExp().compile("[" + nun + "|" + mim + "]" + shadda);
...
function getGunnahMatcher(text) {
    ...
    return new String(text).replaceAll(nunSadda, '<font color="red">' + nunSadda +'</font>');
}