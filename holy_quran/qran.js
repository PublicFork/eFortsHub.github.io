...
for(var i = 0; i < surahJsonArray.length; i++)
{
    ...
    innerCode = innerCode+ `<div class=\"col-lg-4 col-12 col-md-6 items\"><div class=\"items-wrapper"><div class="inner-item"><img src="../eFortsHub.ico" alt=""><h4>`+title+`</h4> <p>`+'subtitle'+`</p> <h3>`+titleAr+`</h3></div></div></div>`;
